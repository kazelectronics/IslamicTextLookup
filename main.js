  ...
  async getAyah(verse) {
    ...
    if (this.settings.offlineMode) {
      ...
      if (arabicData) {
        ...
        const verseHeader = `${surahName} ([[Quran ${surahNumber}-${ayahNumber}#User Notes|${surahNumber}:${ayahNumber}]])`;
...
`;
        ...
        createNoteResult += `# ${surahName} (${surahNumber})\n## Verse ${ayahNumber}\n\n`;
        if (translationData) {
          const enText = this.handleParens(translationData.data.ayahs[0].text, this.settings.removeParens);
          createNoteResult += arText + "\n\n" + enText + "\n\n### User Notes\n\n";
        } else {
    ...
    if (this.settings.offlineMode) {
      ...
      if (arabicData) {
        ...
        for (let ayahNum = startAyah+1; ayahNum <= endAyah; ayahNum) {
          verseHeader += `[[Quran ${surahNumber}-${ayahNum}#User Notes|${surahNumber}:${ayahNum}]]`;
          ayahNum++;
          if (ayahNum <= endAyah) {
            verseHeader += " | ";
          }
